// Generated by CoffeeScript 1.7.1
  var myApp = angular.module('selectAddress',['treeApp','oc.lazyLoad','ui.router','ui.bootstrap','ui.sortable','selectAddress','oc.lazyLoad','ngAnimate']);

  myApp.directive('selectAddress', function($http, $q, $compile) {
    var cityURL, delay, templateURL;
    delay = $q.defer();
    templateURL = 'designer/D_projectManagement/getProject/index.html';
    cityURL = '../js/designerProject/D_projectManagement/getProject/city.min.js';
